[![Run App Paider, Alex](https://github.com/alexpaider/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/alexpaider/GithubActions/actions/workflows/ci.yml)
